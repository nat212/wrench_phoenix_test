defmodule WrenchPhoenixTestWeb.UrlController do
  use WrenchPhoenixTestWeb, :controller

  alias WrenchPhoenixTest.Urls
  alias WrenchPhoenixTest.Urls.Url

  action_fallback WrenchPhoenixTestWeb.JSONFallbackController
  ...
  def show(conn, %{"id" => id}) do
    with {:ok, url} <- Urls.get_url!(id) do
