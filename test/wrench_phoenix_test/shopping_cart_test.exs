defmodule WrenchPhoenixTest.ShoppingCartTest do
  use WrenchPhoenixTest.DataCase

  alias WrenchPhoenixTest.ShoppingCart

  describe "carts" do
    alias WrenchPhoenixTest.ShoppingCart.Cart

    import WrenchPhoenixTest.ShoppingCartFixtures
  ...
  describe "cart_items" do
    alias WrenchPhoenixTest.ShoppingCart.CartItem
