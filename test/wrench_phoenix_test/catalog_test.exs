defmodule WrenchPhoenixTest.CatalogTest do
  use WrenchPhoenixTest.DataCase

  alias WrenchPhoenixTest.Catalog

  describe "products" do
    alias WrenchPhoenixTest.Catalog.Product

    import WrenchPhoenixTest.CatalogFixtures
  ...
  describe "categories" do
    alias WrenchPhoenixTest.Catalog.Category
