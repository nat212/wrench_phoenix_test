defmodule WrenchPhoenixTest.OrdersTest do
  use WrenchPhoenixTest.DataCase

  alias WrenchPhoenixTest.Orders

  describe "orders" do
    alias WrenchPhoenixTest.Orders.Order

    import WrenchPhoenixTest.OrdersFixtures
  ...
  describe "order_line_items" do
    alias WrenchPhoenixTest.Orders.LineItem
