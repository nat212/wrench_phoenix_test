defmodule WrenchPhoenixTest.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `WrenchPhoenixTest.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> WrenchPhoenixTest.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> WrenchPhoenixTest.ShoppingCart.create_cart_item()
